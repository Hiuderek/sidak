      ...
      <?php } else { ?>
        ...
        <?php if ($this->session->userdata("role_id") == 2) { ?>
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= site_url('Pengguna/halaman_dosen') ?>">
            ...
            <div class="sidebar-brand-text mx-2">PT. Yodya Karya</div>
          </a>
        <?php } else { ?>
          ...
          <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?= site_url('C_Karyawan/karyawan') ?>">Data Karyawan</a>
                <a class="collapse-item" href="<?= site_url('C_Gaji/gajiKaryawan') ?>">Data Gaji Karyawan</a>
                <a class="collapse-item" href="<?= site_url('C_Proyek/proyek') ?>">Laporan Proyek Karyawan</a>
              </div>
            </div>
          </li>
          <!-- <li class="nav-item">
          ...
          <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
              ...
              <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="sidebar-brand-text mx-3">PENGELOLAAN DATA KARYAWAN</div>
              </form>
